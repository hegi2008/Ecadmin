 ...
 * <p>Company: fade </p>
 */
package com.yinhai.shh.order.domain;
...
public class OrderSettlementEntity implements Serializable {
	...
	/**{@linkplain #tscdate}*/
	public OrderSettlementEntity setTscdate(String tscdate) {
	...
	public OrderSettlementEntity setAccountdate(String accountdate) {
	...
	/**{@linkplain #addTime}*/
	public OrderSettlementEntity setAddTime(String addTime) {
	...
	public OrderSettlementEntity setLastUpdate(String lastUpdate) {
