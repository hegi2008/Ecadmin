 ...
 * <p>Company: fade </p>
 */
package com.yinhai.shh.registration.domain;
...
public class RegistrationDetailEntity implements Serializable {
	...
	/**{@linkplain #addTime}*/
	public RegistrationDetailEntity setAddTime(String addTime) {
	...
	public RegistrationDetailEntity setLastUpdate(String lastUpdate) {
