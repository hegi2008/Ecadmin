...
/**
* @package com.yinhai.ec.sso
* <p>Title: ShiroCasLogoutFilter.java</p>
* <p>Description: 定义filter,以实现使用shiro自管理session的单点登出</p>
* @author cjh
* @date 2016年9月8日 上午9:25:51
* @version 1.0
 */
public class ShiroCasLogoutFilter extends AdviceFilter{
	private static final Logger log = LoggerFactory.getLogger(ShiroCasLogoutFilter.class);
