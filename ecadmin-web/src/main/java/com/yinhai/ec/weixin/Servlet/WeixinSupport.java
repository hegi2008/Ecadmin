package com.yinhai.ec.weixin.Servlet;

import static com.yinhai.hyman.weixin.util.BeanUtil.isNull;
import static com.yinhai.hyman.weixin.util.BeanUtil.nonNull;
import static com.yinhai.hyman.weixin.util.CollectionUtil.isEmpty;
import static com.yinhai.hyman.weixin.util.CollectionUtil.isNotEmpty;
import static com.yinhai.hyman.weixin.util.StrUtil.isNotBlank;
...
import com.yinhai.hyman.weixin.handle.EventHandle;
import com.yinhai.hyman.weixin.handle.MessageHandle;
import com.yinhai.hyman.weixin.message.BaseMsg;
import com.yinhai.hyman.weixin.message.TextMsg;
import com.yinhai.hyman.weixin.message.aes.AesException;
import com.yinhai.hyman.weixin.message.aes.WXBizMsgCrypt;
import com.yinhai.hyman.weixin.message.req.BaseEvent;
import com.yinhai.hyman.weixin.message.req.BaseReq;
import com.yinhai.hyman.weixin.message.req.BaseReqMsg;
import com.yinhai.hyman.weixin.message.req.EventType;
import com.yinhai.hyman.weixin.message.req.ImageReqMsg;
import com.yinhai.hyman.weixin.message.req.LinkReqMsg;
import com.yinhai.hyman.weixin.message.req.LocationEvent;
import com.yinhai.hyman.weixin.message.req.LocationReqMsg;
import com.yinhai.hyman.weixin.message.req.MenuEvent;
import com.yinhai.hyman.weixin.message.req.QrCodeEvent;
import com.yinhai.hyman.weixin.message.req.ReqType;
import com.yinhai.hyman.weixin.message.req.ScanCodeEvent;
import com.yinhai.hyman.weixin.message.req.SendMessageEvent;
import com.yinhai.hyman.weixin.message.req.SendPicsInfoEvent;
import com.yinhai.hyman.weixin.message.req.TemplateMsgEvent;
import com.yinhai.hyman.weixin.message.req.TextReqMsg;
import com.yinhai.hyman.weixin.message.req.VideoReqMsg;
import com.yinhai.hyman.weixin.message.req.VoiceReqMsg;
import com.yinhai.hyman.weixin.util.MessageUtil;
import com.yinhai.hyman.weixin.util.SignUtil;
...
public abstract class WeixinSupport {
    ...
    /**
      * @package com.yinhai.ec.weixin.servlet
      * @method isLegal 方法 
      * @describe <p>方法说明:验证消息的确来自微信服务器</p>
      * @return boolean 
      * @author cjh
      * @date 2016年4月14日 上午11:17:50
     */
