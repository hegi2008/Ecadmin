...
public class ValidateUtil {
    ...
    public static boolean isDate(String var0, String var1, String var2) {
        if (isYear(var0) && isMonth(var1) && isDay(var2)) {
            ...
            if (var5 > daysInMonth[var4 - 1]) {
                return false;
            } else {
                return var4 != 2 || var5 <= daysInFebruary(var3);
            }
        } else {
            return false;
        }
    ...
    public static boolean isAnyCard(String var0) {
        if (isEmpty(var0)) {
            ...
            String var1 = stripCharsInBag(var0, " -");
            if (!isCreditCard(var1)) {
                return false;
            } else {
                return isMasterCard(var1) || isVisa(var1) || isAmericanExpress(var1) || isDinersClub(var1) || isDiscover(var1) || isEnRoute(var1) || isJCB(var1);
            }
        }
    }
    ...
    public static String getCardType(String var0) {
        if (isEmpty(var0)) {
            ...
            if (!isCreditCard(var1)) {
                return "Unknown";
            } else if (isMasterCard(var1)) {
                return "MasterCard";
            } else if (isVisa(var1)) {
                return "Visa";
            } else if (isAmericanExpress(var1)) {
                return "AmericanExpress";
            } else if (isDinersClub(var1)) {
                return "DinersClub";
            } else if (isDiscover(var1)) {
                return "Discover";
            } else if (isEnRoute(var1)) {
                return "EnRoute";
            } else {
                return isJCB(var1) ? "JCB" : "Unknown";
            }
        }
    }
    ...
    public static boolean isCardMatch(String var0, String var1) {
        if (isEmpty(var0)) {
            ...
            if (var0.equalsIgnoreCase("VISA") && isVisa(var2)) {
                return true;
            } else if (var0.equalsIgnoreCase("MASTERCARD") && isMasterCard(var2)) {
                return true;
            } else if ((var0.equalsIgnoreCase("AMERICANEXPRESS") || var0.equalsIgnoreCase("AMEX")) && isAmericanExpress(var2)) {
                return true;
            } else if (var0.equalsIgnoreCase("DISCOVER") && isDiscover(var2)) {
                return true;
            } else if (var0.equalsIgnoreCase("JCB") && isJCB(var2)) {
                return true;
            } else if ((var0.equalsIgnoreCase("DINERSCLUB") || var0.equalsIgnoreCase("DINERS")) && isDinersClub(var2)) {
                return true;
            } else if (var0.equalsIgnoreCase("CARTEBLANCHE") && isCarteBlanche(var2)) {
                return true;
            } else {
                return var0.equalsIgnoreCase("ENROUTE") && isEnRoute(var2);
            }
        }
    }
    ...
    public static boolean isNotPoBox(String var0) {
        if (isEmpty(var0)) {
            ...
            if (var1.indexOf("p.o. b") != -1) {
                return false;
            } else if (var1.indexOf("p.o.b") != -1) {
                return false;
            } else if (var1.indexOf("p.o b") != -1) {
                return false;
            } else if (var1.indexOf("p o b") != -1) {
                return false;
            } else if (var1.indexOf("po b") != -1) {
                return false;
            } else if (var1.indexOf("pobox") != -1) {
                return false;
            } else if (var1.indexOf("po#") != -1) {
                return false;
            } else if (var1.indexOf("po #") != -1) {
                return false;
            } else if (var1.indexOf("p.0. b") != -1) {
                return false;
            } else if (var1.indexOf("p.0.b") != -1) {
                return false;
            } else if (var1.indexOf("p.0 b") != -1) {
                ...
                return false;
            } else if (var1.indexOf("p0 b") != -1) {
                return false;
            } else if (var1.indexOf("p0box") != -1) {
                return false;
            } else if (var1.indexOf("p0#") != -1) {
                return false;
            } else {
                return var1.indexOf("p0 #") == -1;
            }
        }
    }
}
