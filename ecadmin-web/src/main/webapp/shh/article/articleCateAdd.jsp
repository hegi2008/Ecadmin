...
<script type="text/javascript">
    ...
    function saveArticleCate() {
        ...
        var url = Base.globvar.basePath + "shh/cate/cateManager/saveArticleCate";
        $.post(url, $("#articleCateForm").serializeArray(), function (data) {
            if (!data.error) {
                $("#warning").text("新增文章分类成功,可继续新增").css("display", "block");
            } else {
