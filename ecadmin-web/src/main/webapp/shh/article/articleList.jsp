...
<html>
  ...
  <body>
	...
	<form id="form1"  method="post" class="form-horizontal">
		<div class="row">
		  <div class="form-group col-sm-4 col-lg-4">
				...
				<ec:comboTree id="cate_id_tree"   url="${basePath}admin/articleAdminAction!getCategorys.do" multiple="false" animate="true" lines="true" onSelect="afterEditFunc"></ec:comboTree>
	...
	<div class="container-fluid" style="height: 500px;">
		<ec:grid id="goods" title="文章列表" fit="true" fitColumns="true" pageSize="10" showRowno="true" pagination="true" dataurl="${basePath}admin/articleAdminAction!artilceList.do">
			<ec:gridToolbar>
			...
			<ec:gridItem itemId="status" itemName="文章状态" align="center" halign="center" formatter="formatterStatus"></ec:gridItem>
