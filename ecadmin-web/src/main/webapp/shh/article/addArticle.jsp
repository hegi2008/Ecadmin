        ...
        <div class="row">
            <div class=" col-sm-6 col-lg-6 ">
                ...
                <input id="cate_name" name="cate_name" type="text" class="form-control" value="${ae.cate_name }"
                       placeholder="请选择文章类别" readonly="readonly"/>
            ...
            <div class=" col-sm-6 col-lg-6">
                ...
                <div class="input-group ku-wrap">
                    ...
                    <span class="input-group-btn ku-upbutton">
					        <button class="btn btn-default" type="button" id="file_url_button"
                                    value="上传附件">上传附件</button>
					    </span>
                </div>
            </div>
        </div>-->
...
<script type="text/javascript" src="<%=basePath%>statics/js/article/editarticle.js"></script>
